...
def make_features(vibration_intensity=0.02, trend_slope=0.0):
...
def test_high_risk_all_signals_elevated_is_danger():
    features = make_features(vibration_intensity=1.0, trend_slope=5.0)
...
def test_risk_score_bounded_at_100():
    features = make_features(vibration_intensity=10.0, trend_slope=50.0)
...
def test_warning_state_midrange_risk():
    features = make_features(vibration_intensity=0.5, trend_slope=2.0)
